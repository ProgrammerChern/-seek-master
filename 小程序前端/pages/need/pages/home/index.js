...
Page({
    data: {
        ...
        num:1,
        goods:[],
        goodsShowModal: false,
        types:[],
        typeShowModal: false,
        deviceShowModal: false,
        show:true
    },
    onLoad: function(t) {
        var e = this;
        a.util.getUserInfo(function(a) {
            ...
            success: function(a) {
                ...
                e.setData({
                    content: t?t.replace(/\<img/g, '<img style="width:100%;height:auto;disply:block"'):'',
    ...
    changeRadio: function(a) {
        var e = this, t = a.currentTarget.dataset.a;
        e.setData({
            agreementShowModal:!e.data.agreementShowModal,
            provide:t
        });
    },
    close: function() {
    ...
    goodsShowModal: function() {
        var e = this;
        e.setData({
            goodsShowModal:!e.data.goodsShowModal
        });
    },
    typeShowModal: function() {
        var e = this;
        e.setData({
            typeShowModal:!e.data.typeShowModal
        });
    },
    radioselected: function(a) {
        var e = this,index = a.currentTarget.dataset.index;
        e.setData({
            device:index,
            deviceShowModal:!e.data.deviceShowModal
        });
    },
    deviceShowModal: function() {
        var e = this;
        e.setData({
            deviceShowModal:!e.data.deviceShowModal
        });
    ...
    selected: function(a) {
        var e = this,goods=[],type=e.data.type.multivalue, index = a.currentTarget.dataset.index;
        type[index].selected = type[index].selected == true ? false : true;
        for (var o in type) type[o].selected && goods.push(type[o].title+'*'+type[o].number);
        e.setData({
            goods:goods,
            "type.multivalue":type
        });
    },
    typeselected: function(a) {
        var e = this,goods=[],type=e.data.type.selectvalue, index = a.currentTarget.dataset.index;
        type[index].selected = type[index].selected == true ? false : true;
        for (var o in type) type[o].selected && goods.push(type[o].title);
        e.setData({
            types:goods,
            "type.selectvalue":type
        });
    },
    gbindNumber: function(a) {
        var e = this,goods=[],type=e.data.type.multivalue, index = a.currentTarget.dataset.index;
        if (a.detail.value == 0 ) {
            a.detail.value = 1;
        }
        type[index].number = a.detail.value;
        for (var o in type) type[o].selected && goods.push(type[o].title+'*'+type[o].number);
        e.setData({
            goods:goods,
            "type.multivalue":type
    ...
    gsubtract: function(a) {
        var e = this,goods=[],type=e.data.type.multivalue, index = a.currentTarget.dataset.index;
        type[index].number = type[index].number>2?--type[index].number:1;
        for (var o in type) type[o].selected && goods.push(type[o].title+'*'+type[o].number);
        e.setData({
            goods:goods,
            "type.multivalue":type
    ...
    formSubmit: function(t) {
        ...
        if ("" != e.data.address && null != e.data.address) {
            ...
            e.data.type.num !='' && (d.num=e.data.type.num,d.numvalue=e.data.num),e.data.type.multi !='' && e.data.goods !='' && (d.multi=e.data.type.multi,d.multivalue=e.data.goods),e.data.type.select !='' && e.data.types !='' && (d.select=e.data.type.select,d.selectvalue=e.data.types),e.data.type.radio !='' && e.data.device>=0 && (d.radio=e.data.type.radio,d.radiovalue=e.data.type.radiovalue[e.data.device]),e.data.type.tips !='' && e.data.provide>=0 && (d.tips=e.data.type.tips,d.tipsvalue= e.data.provide==1?'需要':'不需要');
            a.util.request({
