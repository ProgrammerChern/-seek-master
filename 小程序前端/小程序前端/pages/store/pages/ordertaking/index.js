...
Page((a = {
    ...
    updateUserInfo: function(t) {
        var a = this;
        a.hideDialog(), e.util.getUserInfo(function(t) {
            e.util.request({
                url: "entry/wxapp/Api",
                data: {
                    m: "ox_master",
...
}), t(a, "baojia", function(t) {
    this.data.detail.baojia ? wx.navigateTo({
        url: "/pages/store/pages/offer/index?id=" + t.currentTarget.dataset.orderid
    }) : wx.showModal({
        title: "系统消息",
        content: "认证并支付保证金后才可以报价抢单",
        success: function(t) {
            wx.navigateTo({
                url: "/pages/idcard/personal/index"
            });
        }
    });
