...
Page({
    ...
    formSubmit: function(e) {
        var a = this;
        "" != e.detail.value.phone && "undefined" != e.detail.value.phone ? "" != e.detail.value.name && "undefined" != e.detail.value.name ? /^1[3456789]\d{9}$/.test(e.detail.value.phone) ? "" != e.detail.value.address && "undefined" != e.detail.address ? "" != e.detail.value.address_detail && "undefined" != e.detail.address_detail ? t.util.request({
            url: "entry/wxapp/Api",
            data: {
                m: "ox_master",
                r: "address.create",
